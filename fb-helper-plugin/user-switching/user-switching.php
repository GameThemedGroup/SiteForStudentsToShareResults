...
class user_switching {
	...
	public function __construct() {
		...
		// NOTNEEDED add_filter( 'user_row_actions',                array( $this, 'filter_user_row_actions' ), 10, 2 );
		add_action( 'plugins_loaded',                  array( $this, 'action_plugins_loaded' ) );
		add_action( 'init',                            array( $this, 'action_init' ) );
		// NOTNEEDED add_action( 'all_admin_notices',               array( $this, 'action_admin_notices' ), 1 );
		add_action( 'wp_logout',                       'wp_clear_olduser_cookie' );
		add_action( 'wp_login',                        'wp_clear_olduser_cookie' );

		# Nice-to-haves:
    /* NOTNEEDED
		start add_filter( 'ms_user_row_actions',             array( $this, 'filter_user_row_actions' ), 10, 2 );
